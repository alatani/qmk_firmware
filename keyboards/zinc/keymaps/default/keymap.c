...
[_QWERTY] = LAYOUT_ortho_4x12(
      ...
      KC_LGUI, KC_ESC,  KC_LALT, EISU,   LOWER,   KC_SPC,                   KC_ENT,   RAISE,    KANA,    _______, ADJUST,  KC_ESC \
      ),
  ...
  [_LOWER] = LAYOUT_ortho_4x12( \
      ...
      KC_LCTL, _______, _______, _______, _______, _______,                  _______, _______, KC_PGUP,   JP_AT, JP_LBRC, KC_PIPE, \
      KC_LSFT, _______, _______, _______, _______, _______,                  _______, KC_HOME, KC_PGDN,  KC_END, JP_RBRC, JP_BSLS, \
  ...
  /* Adjust (Lower + Raise)
   * ,-----------------------------------------.             ,-----------------------------------------.
   * | Esc  | Reset|RGBRST|Aud on|Audoff|      |             |      |      |      |      |      | Ins  |
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * | Ctrl |RGB ON| HUE+ | SAT+ | VAL+ | Mac  |             | Win  |      |  Up  |Print |ScLock|Pause |
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * | Shift| MODE | HUE- | SAT- | VAL- |MODE R|             |      | Left | Down | Right|      |      |
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * |  Gui |      |      |      |      |      |             |      |      |      |      |      |      |
   * `-----------------------------------------'             `-----------------------------------------'
   */
    [_ADJUST] =  LAYOUT_ortho_4x12( \
      KC_ESC, RESET,   RGBRST,  _______, _______, _______,                   _______, _______, _______, _______,  _______, KC_INS, \
      KC_LCTL, RGB_TOG, RGB_HUI, RGB_SAI, RGB_VAI, AG_NORM,                   AG_SWAP, _______,   KC_UP, KC_PSCR, KC_SLCK, KC_PAUS,\
      KC_LSFT, RGB_MOD, RGB_HUD, RGB_SAD, RGB_VAD, RGB_RMOD,                   _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______,\
      KC_LGUI, _______, _______, _______, _______, _______,                   _______, _______, _______, _______, _______, _______ \
      )
};
